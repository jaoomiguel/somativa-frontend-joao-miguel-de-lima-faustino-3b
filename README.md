...
Breve descrição do que o seu projeto faz. (Ex: Este é um projeto desenvolvido para a avaliação de Front-End, focado em criar interatividade para uma loja/app de [SomativaCinema]).
...
👨‍💻 Autor
[João Miguel de Lima Faustino] [Seu LinkedIn ou GitHub]